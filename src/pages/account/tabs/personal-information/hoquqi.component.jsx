...
const Hoquqi = () => {
  return (
    <div className="content">
      <TextInput label="نام ثبتی شرکت" input />
      <TextInput label="کد ثبتی" input />
      <TextInput label="شناسه ملی" input />
      <TextInput label="کد اقتصادی" input />
      <TextInput label="استان" dropDown dropItems={["تهران", "کرج", "شیراز"]} />
